...
/**
 * Represents a report parameter with attributes such as type, name, value,
 * and format. This class manages parameter metadata, including its type and
 * optional date formatting when applicable.
 *
 * @since 1.0.0
 */
@Component()
...
public class Parameter {
    ...
    /**
     * Enumeration representing different types of parameters that can be used
     * in the Parameter class for handling type-specific data.
     * <p>
     * Each constant in this enumeration corresponds to a specific data type
     * supported by the Parameter class.
     *
     * @since 1.0.0
     */
    ...
    public Parameter(Types types, String name, String value) {
        logger.debug("New instance of {} of type {}, name {}", this.getClass().getName(), types, name);
        setType(types);
        setName(name);
        setValue(value);
        setFormat(null);
    ...
    public Parameter(Types types, String name, String value, String format) {
        logger.debug("New instance of {} with type, name, value, format", this.getClass().getName());
        setType(types);
        setName(name);
        setValue(value);
        setFormat(format);
